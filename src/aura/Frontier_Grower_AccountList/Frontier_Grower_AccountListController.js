({
    ...
    navigateToGrowerList : function(component,event){
        ...
        console.log('Grower_AccountList=>'+accountId);
        $A.createComponent("c:Frontier_GrowerAccountList",
                           {
                               accountId: accountId
                           },
                           function(GrowerList){
                               console.log('DealerGrowerList');
        ...
        try{
            $A.createComponent(
                "c:Frontier_GrowerAccount_UpdateTouchPoint",
                {
                    ...
                    "dealerId" : '',
                    "isGrowerList" : component.get("v.isGrowerList")
                },
                function(newCmp){
    ...
    navigateToDelaerList :function(component,event,helper){
        var accountId = event.getParam("accountId"); //growerId
