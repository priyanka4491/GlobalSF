({
    loadPgmChart : function(component,event,helper) {        
        console.log('Inside chartHelp Dealer Grower');
        ...
        var dataSet=[];
        var labels=[];
        var dealeruniquechart;
        
        dealeruniquechart = 'dealeruniquechart'+component.get("v.identifier");
        
        console.log(dealeruniquechart + 'dealeruniquechart');
        var el = document.getElementById(dealeruniquechart);
        console.log(el + 'el');
        var context = el.getContext('2d');
        if((component.get("v.identifier")) == 1){
            console.log('identifier 1');
            dataSet = [component.get("v.allocated"),component.get("v.available"), component.get("v.consumed")];
            ...
            console.log(labels + 'labels2');
                ...
                console.log(dataSet + 'dataset');                
                    ...
                    var centext = 'Accts. using\nProd.';
                    console.log(dataSet + 'dataset');                
                }
                   else if((component.get("v.identifier") == 6)){
                    console.log('identifier 6');
                    dataSet = [component.get("v.product1"),component.get("v.product2"),component.get("v.product3")];
                    //labels = [component.get("v.product1"),component.get("v.product2"),component.get("v.product3")];
                    labels =['Product1','Product2','Product3'];
                    var centext = 'Accts. using\nProd.';
        ...
        var options = {
            ...
            animation: {
                ...
                onComplete: function () {
                    ...
                    var identity = component.get("v.identifier");
                    if((component.get("v.identifier")) != 6 && identity.length == 1){
                    ctx.beginPath();
                   ...
                   var canvas = document.getElementById(dealeruniquechart);
                    //var canvas = component.find("dealerchart2");
                 // var canvas = component.find('chart'+component.get("v.identifier"));
                    ...
                    var dealerprogramlegendId;
                   
                   
                     dealerprogramlegendId = 'dealeruniquechartlegend' + component.get("v.identifier");
                    
                    console.log('dealerprogramlegendId' + dealerprogramlegendId);
                    document.getElementById(dealerprogramlegendId).innerHTML = pgmDChart.generateLegend();
                    $A.util.addClass(component.find(dealerprogramlegendId),'chart-lgnd');
                }
            })