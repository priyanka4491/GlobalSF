({
    loadPgmChart : function(component,event,helper) {        
        ...
        var dataSet=[];
        var labels=[];
        var dealergrowerpgmChart;
       
        dealergrowerpgmChart = 'mygrowerchart'+ component.get("v.identifier");
        
        console.log(dealergrowerpgmChart + 'dealergrowerpgmChart');
        var el = document.getElementById(dealergrowerpgmChart);
        console.log(el + 'el');
        ...
        var options = {
            ...
            animation: {
                ...
                onComplete: function () {
                    ...
                    var canvas = document.getElementById(dealergrowerpgmChart);
                    ...
                    var growerpgmlegendId;
                    
                     growerpgmlegendId = 'mygrowerchartlegend' + component.get("v.identifier");
                    
                    console.log('legend' + component.get("v.comp"));
                    document.getElementById(growerpgmlegendId).innerHTML = pgmDChart.generateLegend();
                    $A.util.addClass(component.find(growerpgmlegendId),'chart-lgnd1');
                }
            })