({
    loadPgmChart : function(component,event,helper) {        
        ...
        if((component.get("v.identifier"))==5){
          progdealerChart = 'dealergrowerchart'+component.get("v.identifier")+component.get("v.programId");  
        }
        else{
        progdealerChart = 'dealergrowerchart'+component.get("v.identifier");
        }
        console.log(progdealerChart + 'progdealerChart');
        var el = document.getElementById(progdealerChart);
        console.log(el + 'el');
        ...
        var options = {
            ...
            animation: {
                ...
                onComplete: function () {
                    ...
                    var canvas = document.getElementById(progdealerChart);
                    ...
                    var pgmdealerlegendId;
                    if((component.get("v.identifier"))==5){
                        pgmdealerlegendId= 'dealergrowerchartLegend1'+component.get("v.identifier")+component.get("v.programId");
                    }
                    else{
                     pgmdealerlegendId = 'dealergrowerchartLegend1'+ component.get("v.identifier");
                    }
                    console.log('legend' + component.get("v.comp"));
                    document.getElementById(pgmdealerlegendId).innerHTML = pgmDChart.generateLegend();
                    $A.util.addClass(component.find(pgmdealerlegendId),'chart-lgnd1');
                }
            })